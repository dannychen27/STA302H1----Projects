...
<!-- - median COVID times are similarly low for weeks 1 - 3 -->
<!-- - slight increase in median COVID time in week 4 -->
<!-- - all 4 weeks contain outliers -->

<!-- - similar spreads (IQR) for weeks 1 - 2  -->
<!-- - more spread in week 3, even larger spread in week 4 -->
...
<!-- - all 4 weeks contain outliers -->
<!-- - week 4 has largest outliers, ranging from 30 - 70 hours of studying -->
<!-- - median amount of studying steadily increasing from 7 hours to 9 hours in weeks 1 - 3, and noticeable increase from week 3 to week 4 (9 hours to 11 hours)  -->
<!-- - similar spreads (IQR) for weeks 1 - 2 -->
<!-- - more spread in week 3, even larger spread in week 4 -->
...
<!-- - quizzes 1, 2, 4 have outliers -->
<!-- - quiz 1 has most outliers, but they are mild -->
<!-- - quiz 2 only has 1 outlier, but it is the lowest (1/10) -->

<!-- - median quiz scores for quiz 1, 3, and 4 were similar (8/10), with week 2 with highest median quiz score (8.8/10) -->
<!-- - week 2 and 3 both have similarly large spreads, week 1 has smallest spread.  -->
<!-- - week 4 quiz scores are the least skewed -->
...
hist(test_model$residuals,
     main = "Histogram of Residuals of Testing Model",
     xlab = "Observed Residual",
     ylab = "Frequency")
```
...
<!-- - significant t-values for important predictor variables -->
<!-- - Small standard error of the regression coefficients -->
<!-- - No estimated regression coefficients had an opposite sign of that expected from theoretical considerations or prior experience, for instance -->
<!-- - agrees with our intuition about initial COVID shock + downward trend followed up upward trend. -->

<!-- (TODO: VIF for multicollinearity.) -->
...
<!-- ```{R} -->
<!-- simple_model = lm( -->
<!--   quiz4 ~ quiz3 + I(covid2 * covid3) + I(study2 * study3) + I(study3 * study4) -->
<!-- ) -->
<!-- VIF <- vif(simple_model) -->
<!-- VIF -->
<!-- mean(VIF) -->
<!-- ``` -->
...
<!-- ```{r} -->
<!-- # variable recentering -->
<!-- ``` -->

<!-- (TODO: Correlation matrix of final model.) -->

<!-- ```{r} -->
<!-- # correlation matrix of recentered model -->
<!-- ``` -->
