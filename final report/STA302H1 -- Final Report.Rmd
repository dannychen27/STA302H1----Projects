...
(TODO: Change quiz variables to ordinal)
...
(TODO: Display residual plot of covid1 has quadratic relationship.)
...
(TODO: Show plot of residual vs. fitted I(covid1 ^ 2).) \newline
(TODO: Show plot of residual vs. fitted I(covid1 * covid2).) \newline
(TODO: Show plot of residual vs. fitted I(covid2 * covid3).) \newline
(TODO: Show plot of residual vs. fitted I(study1 * study2).) \newline
(TODO: Show plot of residual vs. fitted I(study1 * study3).) \newline
...
(TODO: Show scale-location model has straight line with randomly spread points.) \newline
(TODO: Show residual vs. fitted model show equally spread residuals around horizontal line.)
...
By inspection, the histograms of residuals for the final model looks approximately normal.
Therefore, the error terms are approximately normal.

(TODO: Show QQplot of final model.) \newline
(TODO: Show histogram of residuals for final model.)
