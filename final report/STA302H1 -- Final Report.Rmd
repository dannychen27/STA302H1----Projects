...
To refine the original model, I use backwards selection to remove insignificant terms (terms whose $p$-values were > 0.05) and find a subset model with the lowest AIC value. This refined model using quiz 4 as the response variable; quiz3, and the interaction terms \texttt{study1 * study2}, \texttt{study2 * study3}, \texttt{study3 * study4} as the predictor variables. I perform all further analyses on the final model. \newline
