...
The mean of the residuals of the test model was $-3.715 \times 10 ^ {-17}$, which is approximately 0. See page 32 in the appendix for the corresponding R output.
...
The $t$-test results showed that the $p$-value is 1, which means $H_0$ fails to be rejected, meaning that $\mu_{residuals} = 0$ holds. Since 0 falls inside the 95% confidence interval for the mean of residuals of $(-0.3887752, 0.3887752)$, the $H_0$ fails to be rejected. Therefore, $\mu_{residuals} = 0$. See page 32 for $t$-test output.
