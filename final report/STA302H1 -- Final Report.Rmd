...
Pairwise scatterplots were created to observe the relationship between the response variable and the explanatory variables. Furthermore, a correlation matrix was constructed to determine the correlations of each pair of covariates along with the response variable and each covariate. A correlation between 0.0 - 0.3 is considered low, 0.3 - 0.5 is moderate, and 0.5 - 1.0 is high.
