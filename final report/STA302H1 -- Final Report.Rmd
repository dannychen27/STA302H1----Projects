...
I will use model diagnostics to verify assumptions of my final model, and address whether or not any variable transformation or a variable re-centering is necessary.

Lastly, I will also consult empirical research and scholarly research to  confirm my findings and propose ways to improve my model.
...
Pairwise scatterplots were created to observe the relationship between the response variable and the explanatory variables. \newline
(TODO: See figure X in appendix)
...
(TODO: The results are displayed in Figure X in the appendix.) 

A correlation between 0.0 - 0.3 is considered low, 0.3 - 0.5 is moderate, and 0.5 - 1.0 is high.
...
I chose not to perform any variable transformations on my final model because the residual plots showed that the errors were randomly distributed around 0. I also opted not to re-center my variables since only a few entries in the correlation matrix have high correlation (correlation $\geq$ 0.50).
