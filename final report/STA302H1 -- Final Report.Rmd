...
To verify assumption 3, the scatterplot of residuals versus fits for all predictor variables must not have a "megaphone effect" or a "bowtie effect" where residuals tend to increase/decrease as fits increase.
...
To verify assumption 4, we could either show that all points on a QQplot follow the QQline closely or show that the histogram of residuals is approximately normal.
