...
The table on page 29 in the appendix showing the sample size of every country in this study also suggests that the correlation matrices for individual countries should not be used, as the correlation matrix of all countries is based on more data than the correlation matrices of individual countries combined.
