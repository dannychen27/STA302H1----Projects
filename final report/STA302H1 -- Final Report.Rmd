...
The R output of running the backwards algorithm using the stepAIC function can be found in the R markdown file only, whereas the R output of the final model can be found on page 32 of the appendix.
