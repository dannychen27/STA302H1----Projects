...
# cor(no_country, use = "complete.obs")  # TODO: na./rm = true
```
...
mean_COVID_contemplation_times <- data.frame(
  ...
  week3 = mean(sta302_performance_data$COVID.hours..W3., na.rm = TRUE),  # TODO: Clean column.
  week4 = mean(sta302_performance_data$COVID.hours..W4., na.rm = TRUE)   # TODO: Clean column.
)
