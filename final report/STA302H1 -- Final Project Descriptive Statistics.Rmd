...
```{r}
# TODO: See toy programs to learn how to create histograms with ggplot. -- DONE
# TODO: See Demo 1 to figure out how to add histograms using grid.arrange. -- IGNORE
...
# TODO: See toy program of boxplots to see how to color them by factor -- DONE
...
# three different pairs function

# quiz4 ~ quiz 1, 2, 3
# covid4 ~ covid 1, 2, 3
# sta302h14 ~ sta302h1 1, 2, 3

# or pick out 4 - 5 scatterplots that have interesting relationships

# back up with correlation
# scatterplot more informative as a first step
...
# exploratory data analysis should contain descriptive statistics.

# what to do with Correlation Matrix

# - preliminary data analysis shows these two vars are significant... so we did this .... and explored these variables more closely
# put correlation matrix in appendix for further details; they don't belong in a formal report

# show residual plots in final report -- justifying model

## ggsummary -- demo 3 or 4 -- for nicely formatted tables.
...
round(cor(rows_with_no_country, use = "pairwise.complete.obs", method = "pearson"), 2)  # TODO: na.rm = true  $ pairwise complete obs. is less picky than complete obs.
```
