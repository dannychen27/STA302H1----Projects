...
```{r echo = FALSE}
canadians = canada
non_canadians = dplyr::union(china, india)
non_canadians = dplyr::union(non_canadians, japan)
non_canadians = dplyr::union(non_canadians, mongolia)

non_canadians = dplyr::union(non_canadians, pakistan)
non_canadians = dplyr::union(non_canadians, singapore)

non_canadians = dplyr::union(non_canadians, south_korea)
non_canadians = dplyr::union(non_canadians, taiwan)

non_canadians = dplyr::union(non_canadians, uae)
non_canadians = dplyr::union(non_canadians, unknown)
non_canadians = dplyr::union(non_canadians, usa)
```

```{r}
quiz1 = canadians$Quiz_1_score
quiz2 = canadians$Quiz_2_score
quiz3 = canadians$Quiz_3_score
quiz4 = canadians$Quiz_4_score

covid1 = canadians$COVID.hours..W1.
covid2 = canadians$COVID.hours..W2.
covid3 = canadians$COVID.hours..W3.
covid4 = canadians$COVID.hours..W4.

study1 = canadians$STA302.hours..W1.
study2 = canadians$STA302.hours..W2.
study3 = canadians$STA302.hours..W3.
study4 = canadians$STA302.hours..W4.
...
additive_model = lm(
  ...
  + I(covid1 * study1) + I(covid2 * study2) + I(covid3 * study3) + I(covid4 * study4)
)
...
```{r echo = FALSE}
# additive_model.fit = fitted(additive_model)
# residuals = resid(additive_model)
# ggplot(prof, aes(x = Experience, y = residuals)) +
#   geom_point(size = 2, shape = 23) + geom_hline(yintercept = 0)
```

```{r}
quiz1 = non_canadians$Quiz_1_score
quiz2 = non_canadians$Quiz_2_score
quiz3 = non_canadians$Quiz_3_score
quiz4 = non_canadians$Quiz_4_score

covid1 = non_canadians$COVID.hours..W1.
covid2 = non_canadians$COVID.hours..W2.
covid3 = non_canadians$COVID.hours..W3.
covid4 = non_canadians$COVID.hours..W4.

study1 = non_canadians$STA302.hours..W1.
study2 = non_canadians$STA302.hours..W2.
study3 = non_canadians$STA302.hours..W3.
study4 = non_canadians$STA302.hours..W4.
